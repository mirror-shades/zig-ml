...
This is an OCR ML library rewritten in Zig. It was written to be more idiomatic to the Zig language, using error handling and struct methods. It reduces LOC by a couple hundred lines.
